    ...
    <section className="bg-white dark:bg-black py-16 md:py-24 px-6 md:px-12 lg:px-20 transition-colors duration-300">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
        ...
        <div className="lg:sticky lg:top-24 h-fit">
          ...
          <a
            href="https://ebay.us/m/6qHeor"
            target="_blank"
            rel="noopener noreferrer"
            className="group relative inline-block w-full sm:w-auto px-10 py-4 bg-black dark:bg-white text-white dark:text-black rounded-full overflow-hidden transition-all shadow-xl text-center"
          >
            <span className="relative z-10 flex items-center justify-center gap-2 font-bold uppercase tracking-tight group-hover:text-white dark:group-hover:text-[#FF4B4B] transition-colors duration-300">
              Browse Our Inventory
              <span className="group-hover:translate-x-1 transition-transform">→</span>
            </span>
            <div className="absolute inset-0 bg-[#B62025] translate-y-full group-hover:translate-y-0 transition-transform duration-300"></div>
          </a>
        </div>
