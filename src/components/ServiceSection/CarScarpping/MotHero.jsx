      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl lg:text-5xl font-black mb-6 text-[#111827] dark:text-white">
            <span style={{ color: "#C8102E" }}>Car Scrapping</span>
          </h1>

          {/* Subheading */}
          <p className="text-xl max-w-3xl mx-auto leading-relaxed text-[#4B5563] dark:text-gray-400">
            Trust us to handle your car scrapping needs with
efficiency and professionalism while contributing to a cleaner, greener future.o perform.
          </p>
